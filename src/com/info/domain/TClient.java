 ...
 */
@Entity
@Table(name = "T_Client", schema = "dbo", catalog = "SDOffice")
public class TClient implements java.io.Serializable {
	...
	/** minimal constructor */
	public TClient(Integer FId, Integer FIndustry, String FCord, String FName,
			String FLegalPerson, String FPrincipar, String FEntryPeople,
			Timestamp FEntryTime, String FPossition) {
		this.FId = FId;
	...
	/** full constructor */
	public TClient(Integer FId, Integer FIndustry, String FCord, String FName,
			String FShortName, String FLegalPerson, String FPrincipar,
			String FAddress, String FBank, String FAccount, String FZipCord,
			String FTel, String FFax, String FEmail, String FEntryPeople,
			Timestamp FEntryTime, String FPossition, Integer FUserId,
			String FUserName, Integer FSort) {
		this.FId = FId;
		this.FIndustry = FIndustry;
		this.FCord = FCord;
		this.FName = FName;
