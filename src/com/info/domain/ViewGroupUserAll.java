...
/**
 * ViewGroupUserAll entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "View_GroupUserAll", schema = "dbo", catalog = "SDOffice")
public class ViewGroupUserAll implements java.io.Serializable {
	...
	/** default constructor */
	public ViewGroupUserAll() {
	}

	/** minimal constructor */
	public ViewGroupUserAll(Integer FId) {
		this.FId = FId;
	}

	/** full constructor */
	public ViewGroupUserAll(Integer FId, String FUserCode, String FName,
			...
			Integer FGroupstate, Integer fkOrgId) {
		this.FId = FId;
