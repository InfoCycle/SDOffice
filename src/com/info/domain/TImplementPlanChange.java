...
/**
 * TImplementPlanChange entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_ImplementPlanChange", schema = "dbo", catalog = "SDOffice")
public class TImplementPlanChange implements java.io.Serializable {
    ...
    /** default constructor */
    public TImplementPlanChange() {
    }

    /** minimal constructor */
    public TImplementPlanChange(Integer FId) {
        this.FId = FId;
    }

    /** full constructor */
    public TImplementPlanChange(Integer FId, Integer FPid, String FPlanNumbers, Integer fkTaskId,
            String FCollectDataTime, String FProcessImnTime, String FSubmitRewTime, String FIssueResultsTime,
            String FOther, String FDeptOpinion, String FDeptOpinionTime, Integer FDeptOpinionManId,
            String FDeptOpinionManName, String FPlanningPerId, String FPlanningPerName, String FPlanningTime,
            String FCurrentStep, String FLastStep, String FRecordStep, Integer FState) {
        this.FId = FId;
        this.FPid = FPid;
