...
/**
 * TProjectSealsBft entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_ProjectSealsBft", schema = "dbo", catalog = "SDOffice")
public class TProjectSealsBft implements java.io.Serializable {
    ...
    /** default constructor */
    public TProjectSealsBft() {
    }

    /** minimal constructor */
    public TProjectSealsBft(Integer FId) {
	this.FId = FId;
    }

    /** full constructor */
    public TProjectSealsBft(Integer FId, Integer fkTaskId, String FNumbers,
	    String FBidForReason, String FSealContent, Integer FTheApplicantId,
	    String FTheApplicant, String FTheApplicantTime,
	    String FDeptOpinion, String FProductionAco, String FTheGeneralMo) {
	this.FId = FId;
