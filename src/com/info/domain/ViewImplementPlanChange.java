...
/**
 * ViewImplementPlanChange entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "View_ImplementPlanChange", schema = "dbo", catalog = "SDOffice")
public class ViewImplementPlanChange implements java.io.Serializable {
    ...
    /** default constructor */
    public ViewImplementPlanChange() {
    }

    /** minimal constructor */
    public ViewImplementPlanChange(Integer rowid) {
        this.rowid = rowid;
    }

    /** full constructor */
    public ViewImplementPlanChange(Integer rowid, Integer FId, String FPlanNumbers, Integer fkTaskId,
            String FCollectDataTime, String FProcessImnTime, String FSubmitRewTime, String FIssueResultsTime,
            String FOther, String FDeptOpinion, String FDeptOpinionTime, String FPlanningPerId,
            String FPlanningPerName, String FPlanningTime, String FTaskName, String FServiceCategory,
            String FServiceCategoryName, String FEntrustUnitName, String FProjMgrName, Integer FDeptMgrId,
            String FDeptMgrName, String FCurrentStep, String FLastStep, String FRecordStep, Integer FState) {
        this.rowid = rowid;
        this.FId = FId;
